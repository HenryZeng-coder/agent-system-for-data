...
class TestDedupAndRank:
    ...
    def _make_results(self):
        return [
            {"title": "示例AI公司", "url": "http://a.com/1", "summary": "", "source": "baidu"},
            {"title": "示例AI公司", "url": "http://a.com/1", "summary": "", "source": "sogou"},  # 同URL
            {"title": "示例AI公司", "url": "http://b.com/2", "summary": "", "source": "bing"},   # 同标题
            {"title": "示例AI招聘", "url": "http://c.com/3", "summary": "招聘", "source": "so360"},
        ]
    ...
    def test_rank_by_relevance(self):
        ...
        results = [
            ...
            {"title": "示例 AI 公司 招聘", "url": "http://b.com/2", "summary": "示例 AI", "source": "so360"},
        ]
        ranked = e._rank_by_relevance(results, "示例 AI 公司")
        # 相关度高的排前面
        assert ranked[0]["title"] == "示例 AI 公司 招聘"
