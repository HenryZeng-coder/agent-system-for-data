#!/usr/bin/env python3
"""
将企业名单 CSV (含工商字段者更佳) 导入 companies 表

用法: python scripts/import_csv_to_db.py [--csv PATH] (status='raw'), 供爬虫补全数据后评分。
...
def main():
    ...
    parser = argparse.ArgumentParser(description="企业名单 CSV → companies 表")
